...
const YOUTUBE_ID = "BqEvIh-jUDg";

export const claudeAiAzPayeFa: Tutorial = {
  slug: "claude-ai-az-paye",
  locale: "FA",
  ...
  date: "۳۰ ژوئن ۲۰۲۶",
  content: `<p>در این ویدیو بخش‌های مختلف هوش مصنوعی Claude را توضیح داده‌ام. این آموزش مربوط به وبینار رایگان آشنایی با Claude است که اوایل ژوئن ۲۰۲۶ ضبط شده.</p>
<p>با Claude Chat، Claude Cowork، Claude Code و Claude Design آشنا می‌شوید و می‌بینید هر بخش برای چه کاری مناسب است.</p>
...
<ul>
  <li>تفاوت پلان‌ها و محدودیت استفاده</li>
  <li>چطور در Claude Chat پرامپت بنویسید</li>
  <li>تنظیمات، پروژه، Artifacts و Skills</li>
  <li>اتصال ابزارها با Connectors و MCP</li>
  <li>طراحی با Claude Design</li>
  <li>کار غیر فنی با Claude Cowork</li>
  <li>کدنویسی و ساخت با Claude Code</li>
</ul>`,
};
