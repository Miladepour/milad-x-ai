  ...
  switch (format) {
    case "story":
      return {
        ...
        // Sized for phone readability when the 1080px asset is viewed full-width.
        presentedFontSize: 24,
        nameFontSize: 78,
        recognitionFontSize: 22,
        programFontSize: 44,
        hoursFontSize: 22,
        quoteFontSize: 30,
        quoteLineHeight: 1.55,
        footerNameFontSize: 26,
        footerRoleFontSize: 18,
        footerOrgFontSize: 20,
        footerMetaFontSize: 20,
        footerTitleFontSize: 18,
        footerCredentialFontSize: 18,
        footerNumberFontSize: 20,
        signatureHeight: 92,
    ...
    case "post":
      return {
        ...
        presentedFontSize: 22,
        nameFontSize: 64,
        recognitionFontSize: 20,
        programFontSize: 36,
        hoursFontSize: 20,
        quoteFontSize: 26,
        quoteLineHeight: 1.5,
        footerNameFontSize: 22,
        footerRoleFontSize: 16,
        footerOrgFontSize: 18,
        footerMetaFontSize: 18,
        footerTitleFontSize: 16,
        footerCredentialFontSize: 16,
        footerNumberFontSize: 18,
        signatureHeight: 68,
