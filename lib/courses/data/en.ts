    ...
    tutors: [
      {
        ...
        about: {
          FA: [
            "من صادق گرافر هستم؛ آرت دایرکتور، طراح گرافیک و تولیدکننده محتوای بصری. بیش از ۲۰ ساله که در حوزه طراحی، تبلیغات و برندینگ فعالیت می‌کنم.",
            "در سال‌های اخیر تمرکز من روی ترکیب طراحی و هوش مصنوعی بوده؛ از تصویرسازی و ویدیوسازی گرفته تا تولید محتوای تبلیغاتی و شبکه‌های اجتماعی.",
            "در این ورکشاپ تجربه عملی خودم را از استفاده حرفه‌ای از AI در تولید محتوا و پروژه‌های واقعی با شما به اشتراک میذارم.",
          ],
          EN: [
